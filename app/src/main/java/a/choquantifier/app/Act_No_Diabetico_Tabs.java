...
import a.choquantifier.app.fragments.Act_grafico_nodiabetico_fragment;
...
public class Act_No_Diabetico_Tabs extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_no_diabetico_tabs);
              ...
              public void onPageSelected(int position) {
                  switch(position) {
                      case 0:
                          ...
                          toolbar.setTitle("Calcular Carbohidratos");
                          break;
                      case 1:
    ...
    private void setupViewPager(ViewPager viewPager) {
        ...
        adapter.addFrag(new Act_modo_calculo_fragment(), "");
        adapter.addFrag(new Act_grafico_nodiabetico_fragment(), "");
