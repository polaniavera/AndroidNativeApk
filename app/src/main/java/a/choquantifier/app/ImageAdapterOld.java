...
public class ImageAdapterOld extends BaseAdapter {
    ...
    public ImageAdapterOld(Context contexto, int usuario)
    {   mContext = contexto;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //textoN.setWidth(200);
        textoN.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,0.25f));
        //textoP.setWidth(100);
        textoP.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,0.15f));
        //textoCHO.setWidth(70);
        textoCHO.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,0.15f));
        //textoIG.setWidth(70);
        textoIG.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,0.15f));
        //textoProteina.setWidth(100);
        textoProteina.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,0.15f));
        //textoGrasa.setWidth(70);
        textoGrasa.setLayoutParams(new LinearLayout.LayoutParams(LayoutParams.WRAP_CONTENT, LayoutParams.MATCH_PARENT,0.15f));
