...
public class Act_graficos_independientes extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        getWindow().setFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN,
         ...
         setContentView(R.layout.act_graficos_independientes);
        ...
        // 3 items
        list.add(new LineChartItem(getDataGlucosa(), getApplicationContext()));
        list.add(new LineChartItem(getDataCho(), getApplicationContext()));
        list.add(new BarChartItem(getDataBolos(), getApplicationContext()));
    ...
    private BarData getDataBolos() {
        ...
        set1.setColors(new int[] { R.color.verde, R.color.rojo}, getApplicationContext());
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_graficos_independientes, menu);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        switch (item.getItemId()) {
            ...
            case R.id.action_settings: {
                Intent i = new Intent(this, Act_configuracion.class);
                startActivity(i);
                break;
            }
