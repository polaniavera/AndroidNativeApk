...
public class Act_grafico_combinado extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.act_grafico_combinado);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        getMenuInflater().inflate(R.menu.menu_grafico_combinado, menu);
        return true;
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        switch (item.getItemId()) {
            ...
            case R.id.action_settings: {
                Intent j = new Intent(this, Act_configuracion.class);
                startActivity(j);
                break;
            }
        }
